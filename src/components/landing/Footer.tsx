        ...
        <div className="grid md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-1">
            <Link to="/" className="flex items-center gap-2.5 mb-4 group">
              ...
              <span className="text-lg font-semibold text-foreground">RespirFacile</span>
            </Link>
            <p className="text-muted-foreground text-sm leading-relaxed">
              Exercices respiratoires prescrits par les orthophonistes, pour mieux respirer au quotidien.
            </p>
          </div>
          ...
          {/* Column 4: Votre espace */}
          <div>
            <h4 className="font-semibold text-foreground mb-4 text-sm">Votre espace</h4>
            <ul className="space-y-2.5">
              <li>
        ...
        <div className="border-t border-border/60 mt-10 pt-8">
          <div className="flex flex-col items-center gap-6 text-muted-foreground text-sm">
            <span className="inline-flex items-center gap-2">
              ...
              <span>Conçu avec des orthophonistes spécialisés en rééducation respiratoire</span>
            </span>
            <div className="flex flex-col md:flex-row items-center justify-between gap-4 w-full">
              ...
              <div className="flex items-center gap-4">
                ...
                <span>© {new Date().getFullYear()} RespirFacile</span>
              </div>
            </div>
          </div>
        </div>
