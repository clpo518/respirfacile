  ...
  const features = [
    {
      ...
      desc: "4 profils prêts à l'emploi : apnées légères à modérées, forme sévère sous pression positive continue, thérapie myofonctionnelle, profil mixte. Vous choisissez, vous envoyez le code. C'est tout.",
    },
    {
      emoji: "📓",
    ...
    },
    {
      ...
      desc: "Un patient sans séance depuis 5 jours remonte en tête de votre tableau de bord. Vous intervenez avant que la dynamique se perde.",
    },
    {
      emoji: "🔒",
      title: "Secret médical respecté",
      desc: "Hébergement en France, chiffrement en transit et au repos, cloisonnement appliqué dans la base. Vos patients ne voient que leurs propres données.",
    },
  ]
  return (
    <section id="fonctionnalites" className="py-24 px-4 bg-[#F5F0E8]">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-forest-600 max-w-2xl mx-auto font-light">Rien de superflu. Uniquement ce qui change la régularité entre deux séances.</p>
        </div>
