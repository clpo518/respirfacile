...
const PROFILE_OPTIONS = [
  ...
  },
  {
    ...
    icon: "😴",
    desc: "Vous dormez sous pression positive continue. Votre praticien souhaite accompagner votre traitement, sans jamais le remplacer.",
  ...
  },
  {
    ...
    icon: "👅",
    desc: "Votre orthophoniste ou votre kinésithérapeute a prescrit une rééducation myofonctionnelle.",
